...
bot.hears('O que são bots?', ctx => {
    ctx.replyWithMarkdown('Bots são programas de software que executam tarefas automatizadas, repetitivas e pré-definidas. Os bots normalmente imitam ou substituem o comportamento do usuário humano. Por serem automatizados, operam muito mais rápido do que os usuários humanos. Eles realizam funções úteis, tais como serviço ao cliente ou indexação de motores de busca\n_Algo mais?_', tecladoOpcoes)
});
